...
const handles = Object.fromEntries(easings.map((ease) => [ease.id, ease.handles]));
const css = Object.fromEntries(easings.map((ease) => [ease.id, `cubic-bezier(${ease.handles.join(', ')})`]));
